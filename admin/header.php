  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="viewpro.php">Product Details<span class="sr-only">(current)</span></a></li>
        <li><a href="insertpro.php">Add Product</a></li>
        <li><a href="viewcat.php">Category Details</a></li>
        <li><a href="insertcat.php">Add Category</a></li>
